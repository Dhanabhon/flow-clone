...
const en = {
  ...
  imageContentExact: "Exact",
  imageContentSmart: "Smart",
  imageContentExactHint: "Full disk copy — every block, exactly.",
  imageContentSmartHint:
    "Used space only (NTFS) — faster and smaller; falls back to exact otherwise.",
  imageCompressLabel: "Compress",
  ...
  ejectFailedBody: "Couldn't eject {name}: {message}",
  notifyTitle: "FlowClone",
  notifyImageDone: "Image created successfully",
  notifyImageFailed: "Image creation failed",
  notifyRestoreDone: "Restore completed successfully",
...
const th: Record<MessageKey, string> = {
  ...
  imageContentLabel: "เนื้อหาอิมเมจ",
  imageContentExact: "เต็ม",
  imageContentSmart: "สมาร์ท",
  imageContentExactHint: "คัดลอกทั้งดิสก์ ทุกบล็อกตรงกัน",
  imageContentSmartHint:
    "เฉพาะพื้นที่ที่ใช้ (NTFS) เร็วและเล็กกว่า ถ้าไม่รองรับจะกลับไปแบบเต็ม",
  imageCompressLabel: "บีบอัด",
  ...
  eject: "นำออก",
  ejectFailed: "นำออกไม่สำเร็จ",
  ejectFailedBody: "ไม่สามารถนำ {name} ออกได้: {message}",
  notifyTitle: "FlowClone",
  notifyImageDone: "สร้างอิมเมจสำเร็จ",
  notifyImageFailed: "สร้างอิมเมจไม่สำเร็จ",
  notifyRestoreDone: "กู้คืนอิมเมจสำเร็จ",
  notifyRestoreFailed: "กู้คืนอิมเมจไม่สำเร็จ",
  thunderbolt: "Thunderbolt",
  internal: "ภายใน",
  firewire: "FireWire",
  network: "เครือข่าย",
